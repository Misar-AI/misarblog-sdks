...
Official PHP client for the Misar.Blog developer API. PHP 8.1+, PSR-4, retry with back-off.
...
try {
    ...
    printf("%s plan is out of credits — upgrade at %s\n", $e->plan, $e->upgradeUrl);
}
```
